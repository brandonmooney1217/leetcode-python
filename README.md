...
A structured collection of LeetCode problem solutions implemented in Python, organized by topic.
...
| 787 | Cheapest Flights Within K Stops | Medium | Dynamic Programming, Graphs | [Solution](./dynamic_programming/cheapest-flights-within-k-stop.py) | Not Competent |
...
**Stats**: 35 solved | 31 competent | 3 needs review | 1 not competent

## Problem Solution Pattern

Each problem follows a consistent structure:

**Solution file** (`topic/problem_name.py`):
- LeetCode number, difficulty, and link
- Empty function stub for solving
